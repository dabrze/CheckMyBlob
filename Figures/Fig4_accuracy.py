...
plt.tight_layout()
fig.savefig("Fig4/Fig4_ABCD.png", dpi=DPI)
fig.savefig("Fig4/Fig4_ABCD.png".replace('png', 'svg'), dpi=DPI)
fig.savefig("Fig4/Fig4_ABCD.png".replace('png', 'eps'), rasterize=False, dpi=DPI)
