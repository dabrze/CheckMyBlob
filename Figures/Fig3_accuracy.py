...
plt.tight_layout()
fig.savefig("Fig3/Fig3_ABCD.png", dpi=DPI)
fig.savefig("Fig3/Fig3_ABCD.png".replace('png', 'svg'), dpi=DPI)
fig.savefig("Fig3/Fig3_ABCD.png".replace('png', 'eps'), rasterize=False, dpi=DPI)
